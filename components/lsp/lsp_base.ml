...
let mk_range (p : Pos.pos) : J.t =
  ...
  `Assoc ["start", `Assoc ["line", `Int (line1 - 1); "character", `Int (max 0 (col1 - 1))];
          "end",   `Assoc ["line", `Int (line2 - 1); "character", `Int (max 0 (col2 - 1))]]

let json_of_goal ((meta,hyps,typ) : Pure.goal) =
