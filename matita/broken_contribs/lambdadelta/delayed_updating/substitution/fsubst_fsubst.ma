...
lemma fsubst_fsubst_nol_inv_eq (t) (t1) (t2) (t3) (t4) (u1) (u2) (v1) (v2) (x1) (x2) (y1) (y2):
      t ≬ u1 → t ≬ u2 → u1 ⧸≬ u2 → u1 ⧸≬ v2 → u2 ⧸≬ v1 →
      u1 ⇔ x1 → u2 ⇔ x2 → v1 ⇔ y1 → v2 ⇔ y2 →
      ⬕[u2←v2]t ⇔ t1 → ⬕[u1←v1]t ⇔ t2 →
      ⬕[x1←y1]t1 ⇔ t3 → ⬕[x2←y2]t2 ⇔ t4 →
      t3 ⇔ t4.
#t #t1 #t2 #t3 #t4 #u1 #u2 #v1 #v2 #x1 #x2 #y1 #y2
#Hu1 #Hu2 #Hnu #Hn12 #Hn21 #Hux1 #Hux2 #Hvy1 #Hvy2 #Ht1 #Ht2 #Ht3 #Ht4
