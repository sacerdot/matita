...
lemma subset_le_plrc_single_empty_sx:
      (𝐋❨❴𝐞❵❩) ⊆ Ⓕ.
...
lemma plrc_single_wfinite (p):
      (𝐋❨❴p❵❩) ϵ 𝐖𝛀.
#p elim p -p [| #l #p #IH ]
[ @(subsets_wfinite_le_trans … (subset_le_plrc_single_empty_sx …)) //
| @(subsets_wfinite_le_trans … (subset_le_plrc_single_rcons_sx …))
