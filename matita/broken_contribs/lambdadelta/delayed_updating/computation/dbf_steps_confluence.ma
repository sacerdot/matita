...
lemma dbfss_conf (t0):
      ...
      ∃∃t,ss1,ss2. t1 ➡*𝐝𝐛𝐟[ss1] t & t2 ➡*𝐝𝐛𝐟[ss2] t.
#t0 #Ht0 #t1 #rs1 #H0 @(dbfss_ind_dx … H0) -t1 -rs1
[ #tx #t1 #rst1 #Htx1 #IH #t2 #rs2 #Ht02
  elim (IH … Ht02) -t0 #t #ss1 #ss2 #Ht1 #Ht2
  /3 width=5 by eq_dbfss_trans, ex2_3_intro/
| #t2 #rs2 #Ht02
  /3 width=5 by frs_refl, ex2_3_intro/
| #tx #t1 #rs1 #s1 #Ht0x #Htx1 #IH #t2 #rs2 #Ht02
  lapply (dbfss_preterm_trans … Ht0 Ht0x) -Ht0 -Ht0x #Hx
  elim (IH … Ht02) -t0 #t #ss1 #ss2 #Htx #Ht2
  elim (dbfss_strip … Htx1 … Htx) // -tx #tx #xs1 #xs2 #ht1x #htx
