...
lapply (xprc_des_ol_pA_sx … Hr01 Hp21) -Hp21 #Hp21
lapply (xprc_des_ol_pA_sx … Hr02 Hp12) -Hp12 #Hp12
...
lapply (dbfs_preterm_inv_sx … Ht0 Ht01 Hr01) -Ht01 #Ht01
lapply (dbfs_preterm_inv_sx … Ht0 Ht02 Hr02) -Ht02 #Ht02
elim (xprc_dbfs … Hr12) #t3 #Ht13
elim (xprc_dbfs … Hr21) #t4 #Ht24
cut (t3 ⇔ t4)
[ lapply (dbfs_preterm_inv_sx … Ht1 Ht13 Hr12) -Ht13 -Hr12 #Ht13
  lapply (dbfs_preterm_inv_sx … Ht2 Ht24 Hr21) -Ht24 -Hr21 #Ht24
...
| -Ht0 -Ht02 -Ht2 -Hx -Ht01 -Hnr21 -Hr01 -Hr21
  ...
  >list_append_rcons_sx <list_append_assoc #H0
...
| -Ht0 -Ht02 -Hp12 -Ht2 -Hr02 -Hx -Ht01 -Hnr21 -Hr01 -Hr21 -Hy
  ...
  <path_clear_S_dx >list_append_rcons_sx in ⊢ ((???%)→?);
...
lapply (dbfs_preterm_inv_sx … Ht0 Ht01 Hr01) -Ht01 (* -Hr01 *) #Hs01
lapply (dbfs_preterm_inv_sx … Ht0 Ht02 Hr02) (* -Ht02 -Hr02 *) #Hs02
lapply (dbfs_preterm_inv_sx … Ht1 Ht13 Hr12) -Ht13 -Hr12 #Hs13
lapply (dbfs_preterm_inv_sx … Ht2 Ht24 Hr21) (* -Ht24 -Hr21 *) #Hs24
lapply (dbfs_preterm_inv_sx … Ht4 Ht45 Hr45) -Ht45 -Hr45 #Hs45
...
|9:
  @brd_brd_append_p
  @(subset_eq_canc_sx … (dbfs_des_grafted_nol … Ht2 Ht24 Hr21 …))
  [ #H0 elim (term_ol_inv_slice_bi … H0) #z1 #z2
    >list_append_lcons_sx <list_append_assoc #H0
    @(path_neq_p_beta … H0)
  ]
