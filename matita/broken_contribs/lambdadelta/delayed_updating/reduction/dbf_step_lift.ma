...
include "delayed_updating/reduction/prototerm_delayed_lift.ma".
...
#f #t1 #t2 #r #H0 elim (dbfs_inv_brf … H0) -H0
#p #b #q #n
* #Hr * #H0 #Hb #Hq #Ht2 destruct
@(dbfs_mk_brf … (🠡[f]p) (🠡[🠢[p]f]b) (🠡[🠢[𝐫❨p,b❩]f]q) (🠢[𝐫❨p,b,q❩]f＠§❨n❩))
...
| lapply (in_comp_lift_bi f … Hr) -Ht2 -Hr //
...
#f #t1 #u2 #s #H0 elim (dbfs_inv_brf … H0) -H0 #p #b #q #n
...
@(ex3_2_intro … (⬕[𝐅❨t1,p0,b0,q0,⫰n0❩←𝐃❨t1,p0,b0,q0,⫰n0❩]t1))
[4: // | skip
| @(dbfs_mk_brf … p0 b0 q0 (⫰n0)) [2: // ]
