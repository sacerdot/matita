...
lemma dbfs_pirc_wfinite_sx (t1) (t2) (r):
      t1 ➡𝐝𝐛𝐟[r] t2 → 𝐈❨t1❩ ϵ 𝐖𝛀 → 𝐈❨t2❩ ϵ 𝐖𝛀.
#t1 #t2 #r * #p #b #q #n * #H0 #_ #_ #Hn * #_ #Ht21 #H2t1 destruct
lapply (subset_le_trans … Ht21 … (fsubst_le_sx …)) -Ht21
...
@subsets_wfinite_or
[ @(subsets_wfinite_le_trans … (pirc_pt_append_sx …))
  @subsets_wfinite_or //
  @term_pt_append_wfinite
  @(subsets_wfinite_le_trans … (term_le_pirc_grafted_sx …))
