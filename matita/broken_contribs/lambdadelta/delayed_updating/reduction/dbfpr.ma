...
inductive dbfpr: 𝕋 → relation2 (𝕋) (𝕋) ≝
| dbfpr_refl (t1) (t2) (u):
             t1 ⇔ t2 → u ⊆ Ⓕ → dbfpr u t1 t2
| dbfpr_step (t0) (t1) (t2) (u) (p) (b) (q) (n):
             let r ≝ p●𝗔◗b●𝗟◗q in
             let s ≝ p●𝗔◗(⓪b)●𝗟◗q in
...
interpretation
  ...
  'ParallelBlackRightArrowDBF t1 u t2 = (dbfpr u t1 t2).

(* Constructions with subset_eq *********************************************)

lemma dbfpr_eq_trans (t0) (t1) (u):
      t1 ∥➡𝐝𝐛𝐟[u] t0 → ∀t2. t0 ⇔ t2 → t1 ∥➡𝐝𝐛𝐟[u] t2.
#t0 #t1 #u #H0 elim H0 -t0 -t1 -u
[ #t1 #t0 #u #Ht10 #Hu #t2 #Ht02
  /3 width=3 by dbfpr_refl, subset_eq_trans/
| #tx #t1 #t0 #u #p #b #q #n #Hb #Hq #Ht1 #Hu #Ht0 #_ #IH #t2 #Ht02
...
#t0 #t2 #u #H0 elim H0 -t0 -t2 -u
[ #t0 #t2 #u #Ht02 #Hu #t1 #Ht01
  /3 width=3 by subset_eq_canc_sn, dbfpr_refl/
| #tx #t0 #t2 #u #p #b #q #n #Hb #Hq #Ht0 #Hu #Ht2 #_ #IH #t1 #Ht01
