...
include "delayed_updating/reduction/preterm_immediate_unwind2.ma".
...
[ lapply (in_comp_unwind2_bi f … Hr) -Ht1 -Hb -Ht2 -Hr
...
#f #t1 #u2 #s #Ht1 #H0
elim (ibfs_inv_brf … H0) -H0 #p #b #q #n
* * #s0 #Hs0 #H1 * #H2 #Hb #Hq #Hu2 destruct
elim (eq_inv_unwind2_path_beta … (sym_eq … H2)) -H2 #p0 #b0 #q0 #n0 #H1 #H2 #H3 #H4 #Hn destruct
