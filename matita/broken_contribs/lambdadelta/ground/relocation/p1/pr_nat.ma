...
lemma pr_nat_inv_next_succ (f) (l1) (l2):
      ＠§❨l1,f❩ ≘ l2 → ∀g. ∀k2:ℕ. ↑g = f → (⁤↑k2) = l2 → ＠§❨l1,g❩ ≘ k2.
...
#k1 #k2 #_ #_ * -l2 #H elim (eq_inv_zero_npos … H)
qed-.
...
[ #_ * -l2 #H elim (eq_inv_npos_zero … H)
| #x1 #x2 #Hg #H1 * -l2 #H
