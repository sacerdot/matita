...
(*** monotonic_yle_plus_sx *)
lemma yle_plus_bi_sx (z) (x) (y):
      x ≤ y → z + x ≤ z + y.
/2 width=1 by yle_plus_bi/ qed.
...
(*** yle_plus_dx2 *)
lemma yle_plus_dx_sx_refl (x) (y): y ≤ x + y.
// qed-.
...
(*** yle_inv_monotonic_plus_sx_inj *)
lemma yle_inv_plus_bi_sx_inj (o) (x) (y):
...
(*** yle_fwd_plus_sx2 *)
lemma yle_des_plus_sx_sx (x) (y) (z):
      x + y ≤ z → y ≤ z.
/2 width=3 by yle_trans/ qed-.

(*** yle_fwd_plus_sx1 *)
lemma yle_des_plus_sx_dx (x) (y) (z):
      x + y ≤ z → x ≤ z.
/2 width=3 by yle_trans/ qed-.

(*** yle_fwd_plus_ge *)
lemma yle_des_plus_bi_sx_inj_bi (m) (n) (x) (y):
...
(*** yle_fwd_plus_ge_inj *)
lemma yle_des_plus_bi_sx_inj_sx (o) (z) (x) (y):
      z ≤ yinj_nat o → yinj_nat o + x ≤ z + y → x ≤ y.
#m #z #x #y #H elim (yle_inv_inj_dx … H) -H
#n #Hnm #H destruct
/2 width=4 by yle_des_plus_bi_sx_inj_bi/
qed-.

(*** yle_fwd_plus_yge *)
lemma yle_des_plus_bi_sx_inj_md (m1) (m2) (y1) (y2):
...
/2 width=4 by yle_des_plus_bi_sx_inj_sx/
qed-.
