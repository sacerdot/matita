...
lemma ylt_plus_inf (x) (y):
      x < ∞ → y < ∞ → x + y < ∞.
#x #y #Hx #Hy
elim (ylt_des_gen_sx … Hx) -Hx #m #H destruct
elim (ylt_des_gen_sx … Hy) -Hy #n #H destruct
//
qed.

(*** ylt_plus_dx1_trans *)
lemma ylt_plus_dx_sx (z) (x) (y):
      z < x → z < x + y.
#z #x #y * -z -x //
...
(*** monotonic_ylt_plus_sx_inj *)
lemma ylt_plus_bi_sx_inj (o) (x) (y):
...
(*** monotonic_ylt_plus_sx *)
lemma ylt_plus_bi_sx (z) (x) (y):
      x < y → z < ∞ → z + x < z + y.
...
lemma eq_inv_yplus_bi_dx (z) (x) (y):
      z < ∞ → x + z = y + z → x = y.
#z #x #y #H
elim (ylt_des_gen_sx … H) -H #o #H destruct
...
lemma ylt_des_plus_bi_sx (z) (x) (y):
      z + x < z + y → x < y.
