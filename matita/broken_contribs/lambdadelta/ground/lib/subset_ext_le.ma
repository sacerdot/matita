...
lemma subset_le_ext_f1_exteq (A1) (A0) (f1) (f2) (u):
...
lemma subset_le_ext_f1_bi (A1) (A0) (f) (u1) (v1):
...
lemma subset_le_ext_f1_compose_dx (A0) (A1) (A2) (f1) (f2) (u):
...
lemma subset_le_ext_f1_1_bi (A11) (A21) (A0) (f1) (f2) (u11) (u21) (v11) (v21):
      u11 ⊆ v11 → u21 ⊆ v21 →
...
/3 width=3 by subset_le_ext_f1_bi, or_introl, or_intror/
qed.

lemma subset_le_ext_p1_trans (A1) (Q) (u1) (v1):
