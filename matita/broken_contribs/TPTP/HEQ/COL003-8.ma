set "baseuri" "cic:/matita/TPTP/COL003-8".
include "logic/equality.ma".

(* Inclusion of: COL003-8.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : COL003-8 : TPTP v3.2.0. Released v1.2.0. *)
...
(*  Rating   : 0.57 v3.2.0, 0.43 v3.1.0, 0.56 v2.7.0, 0.33 v2.6.0, 0.29 v2.5.0, 0.40 v2.4.0, 0.50 v2.2.1, 0.88 v2.2.0, 0.83 v2.1.0, 0.67 v2.0.0 *)
