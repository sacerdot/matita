set "baseuri" "cic:/matita/TPTP/COL006-2".
include "logic/equality.ma".

(* Inclusion of: COL006-2.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : COL006-2 : TPTP v3.2.0. Released v1.0.0. *)
...
(*  Rating   : 0.43 v3.1.0, 0.67 v2.7.0, 0.33 v2.6.0, 0.43 v2.5.0, 0.20 v2.4.0, 0.67 v2.2.1, 1.00 v2.0.0 *)
