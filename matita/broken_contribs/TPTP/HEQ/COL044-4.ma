set "baseuri" "cic:/matita/TPTP/COL044-4".
include "logic/equality.ma".

(* Inclusion of: COL044-4.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : COL044-4 : TPTP v3.2.0. Released v1.2.0. *)
...
(*  Rating   : 0.71 v3.2.0, 0.57 v3.1.0, 0.56 v2.7.0, 0.33 v2.6.0, 0.43 v2.5.0, 0.40 v2.4.0, 0.83 v2.2.1, 0.88 v2.2.0, 1.00 v2.0.0 *)
