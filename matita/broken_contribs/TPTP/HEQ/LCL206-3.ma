set "baseuri" "cic:/matita/TPTP/LCL206-3".
include "logic/equality.ma".

(* Inclusion of: LCL206-3.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : LCL206-3 : TPTP v3.2.0. Bugfixed v2.4.1. *)
...
(*  Rating   : 0.43 v3.2.0, 0.14 v3.1.0, 0.33 v2.7.0, 0.17 v2.6.0, 0.50 v2.5.0 *)
