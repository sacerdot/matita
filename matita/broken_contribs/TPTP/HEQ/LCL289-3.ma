set "baseuri" "cic:/matita/TPTP/LCL289-3".
include "logic/equality.ma".

(* Inclusion of: LCL289-3.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : LCL289-3 : TPTP v3.2.0. Released v2.3.0. *)
...
(*  Rating   : 0.71 v3.1.0, 0.67 v2.6.0, 0.57 v2.5.0, 0.60 v2.4.0, 0.67 v2.3.0 *)
