set "baseuri" "cic:/matita/TPTP/COL003-4".
include "logic/equality.ma".

(* Inclusion of: COL003-4.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : COL003-4 : TPTP v3.2.0. Released v1.0.0. *)
...
(*  Rating   : 0.29 v3.1.0, 0.22 v2.7.0, 0.17 v2.6.0, 0.00 v2.5.0, 0.20 v2.4.0, 0.33 v2.2.1, 0.56 v2.2.0, 0.57 v2.1.0, 0.80 v2.0.0 *)
