...
(*  File     : GRP183-1 : TPTP v3.7.0. Bugfixed v1.2.1. *)
...
(*  Rating   : 0.33 v3.4.0, 0.50 v3.3.0, 0.43 v3.1.0, 0.33 v2.7.0, 0.36 v2.6.0, 0.33 v2.5.0, 0.25 v2.4.0, 0.00 v2.2.1, 0.67 v2.2.0, 0.71 v2.1.0, 0.86 v2.0.0 *)
