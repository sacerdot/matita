set "baseuri" "cic:/matita/TPTP/LAT002-1".
include "logic/equality.ma".

(* Inclusion of: LAT002-1.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : LAT002-1 : TPTP v3.2.0. Released v1.0.0. *)
...
(*  Rating   : 0.43 v3.1.0, 0.78 v2.7.0, 0.83 v2.6.0, 0.71 v2.5.0, 1.00 v2.4.0, 0.83 v2.2.1, 0.89 v2.2.0, 0.86 v2.1.0, 1.00 v2.0.0 *)
...
(*             Number of variables   :   30 (   5 singleton) *)
