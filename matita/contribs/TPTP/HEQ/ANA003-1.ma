set "baseuri" "cic:/matita/TPTP/ANA003-1".
include "logic/equality.ma".

(* Inclusion of: ANA003-1.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : ANA003-1 : TPTP v3.2.0. Released v1.0.0. *)
...
(*  Rating   : 0.71 v3.2.0, 0.86 v3.1.0, 0.67 v2.6.0, 0.71 v2.5.0, 0.60 v2.4.0, 0.83 v2.3.0, 1.00 v2.0.0 *)
