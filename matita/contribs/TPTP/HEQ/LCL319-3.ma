set "baseuri" "cic:/matita/TPTP/LCL319-3".
include "logic/equality.ma".

(* Inclusion of: LCL319-3.p *)

(* -------------------------------------------------------------------------- *)

(*  File     : LCL319-3 : TPTP v3.2.0. Released v2.3.0. *)
...
(*  Rating   : 0.71 v3.2.0, 0.57 v3.1.0, 0.56 v2.7.0, 0.67 v2.6.0, 1.00 v2.3.0 *)
