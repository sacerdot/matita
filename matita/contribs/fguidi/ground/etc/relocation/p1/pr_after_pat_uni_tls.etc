...
include "ground/relocation/p1/pr_after_isi.ma".
...
| #i2 #IH #i1 #f2 #Hf2 #f #Hf >npsucc_pos
  elim (pr_pat_inv_succ_dx … Hf2) -Hf2 [1,3: * |*: // ]
  [ #g2 #j1 #Hg2 #H1 #H2 destruct >npsucc_pos in Hf; #Hf
...
| #i2 #IH #i1 #f2 #Hf2 #f >npsucc_pos #Hf
  elim (pr_after_inv_next_sn … Hf) -Hf [2,3: // ] #g #Hg #H destruct
  elim (pr_pat_inv_succ_dx … Hf2) -Hf2 [1,3: * |*: // ]
