...
(*  File     : GRP192-1 : TPTP v3.7.0. Bugfixed v1.2.1. *)
...
(*  Rating   : 0.00 v3.3.0, 0.07 v3.1.0, 0.11 v2.7.0, 0.00 v2.2.1, 0.33 v2.2.0, 0.43 v2.1.0, 0.14 v2.0.0 *)
...
∀H15:∀X:Univ.eq Univ (multiply identity X) X.
eq Univ (multiply a b) (multiply b a)).
#Univ ##.
#X ##.
#Y ##.
#Z ##.
